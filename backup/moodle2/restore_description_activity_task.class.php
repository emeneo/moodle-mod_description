...
class restore_description_activity_task extends restore_activity_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('description', array('intro'), 'description');
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('description', 'add', 'view.php?id={course_module}', '{description}');
        $rules[] = new restore_log_rule('description', 'update', 'view.php?id={course_module}', '{description}');
        $rules[] = new restore_log_rule('description', 'view', 'view.php?id={course_module}', '{description}');
    ...
    static public function define_restore_log_rules_for_course() {
        ...
        $rules[] = new restore_log_rule('description', 'view all', 'index.php?id={course}', null);
